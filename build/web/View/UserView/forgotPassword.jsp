...
<body oncontextmenu='return false' class='snippet-body'>
    <p class="${message==null ? " ": "alert-danger alert" }">${mess}</p>
		...
		<div class="row justify-content-center">
			<div class="col-lg-8 col-md-10">
				...
				<form class="card mt-4" action="ForgotPasswordServlet" method="POST">
                                    <input type="text" name="mode"  value="getOTP" hidden="">
					<div class="card-body">
					...
					<div class="card-footer">
						<button class="btn btn-success" type="submit">Get New
                            ...
                            <a href="AccountServlet?mode=login"><button class="btn btn-danger">Back to
                                                    Login</button></a>
			</div>
		</div>
	</div>
